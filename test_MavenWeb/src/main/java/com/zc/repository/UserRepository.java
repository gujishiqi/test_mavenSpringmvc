...
import com.zc.model.UserinfoEntity;
...
public interface UserRepository extends JpaRepository<UserinfoEntity,Integer> {
    ...
    // 定义查询
    // @Param注解用于提取参数
    @Query("update UserinfoEntity us set us.nickname=:qNickname, us.firstName=:qFirstName, us.lastName=:qLastName, us.password=:qPassword where us.id=:qId")
